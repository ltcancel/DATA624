...
- According to the density plot above, all predictors are left skewed. Therefore transformations are needed for each column. By doing so, we can obtain a better forecast 
